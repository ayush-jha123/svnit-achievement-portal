  ...
  >
    ...
    >
      ...
      >
        ...
        <img src={picUrl} class="size-36 z-40 border-4 border-white rounded-full group-hover:border-8 group-hover:transition-all group-hover:duration-300 transition-all duration-300" id="avatar" alt="Avatar Image"/>
        <div
    ...
    <div class="headings *:text-center *:leading-4">
      <p class="text-xl font-serif font-semibold text-[#434955]">Abhineet lal tamatar</p>
      <p class="text-sm font-bold text-[#434955]">Piro Lover</p>
      <br />
