...
import picUrl from '../../public/assets/bat.jpeg'
  ...
  >
    ...
    >
      ...
      >
        ...
        <img src={picUrl} className="size-36 z-40 border-4 border-white rounded-full group-hover:border-8 group-hover:transition-all group-hover:duration-300 transition-all duration-300" id="avatar" alt="Avatar Image"/>
        <div
    ...
    <div className="headings *:text-center *:leading-4">
      <p className="text-xl font-serif font-semibold text-[#434955]">Abhineet lal tamatar</p>
      <p className="text-sm font-bold text-[#434955]">Piro Lover</p>
      <br />
      <p>Looking for valentine lover Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam doloremque qui placeat. Voluptatibus velit blanditiis cupiditate laboriosam consectetur temporibus consequatur.</p>
    </div>
