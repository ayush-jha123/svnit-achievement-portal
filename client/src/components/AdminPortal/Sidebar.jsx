...
const Sidebar = ({ activeOption, onOptionClick }) => {
  ...
  return (
    <div>
      <div
        class="relative flex h-[calc(100vh-10rem)] w-full max-w-[20rem] flex-col rounded-xl bg-[#223752] bg-clip-border p-4 shadow-xl shadow-blue-gray-900/5">
        <div class="p-4 mb-2">
          <h5 class="name mb-2">
            Administrator
          </h5>
        ...
        <nav class="flex min-w-[240px] flex-col gap-1 p-2 font-sans text-base font-normal text-blue-gray-700">
          ...
          <div
            onClick={() => handleOptionClickLocal('request')} role="button"
            class="flex items-center w-full p-3 leading-tight transition-all rounded-lg outline-none text-start hover:bg-grey hover:bg-opacity-80 hover:text-white focus:bg-blue-gray-50 focus:bg-opacity-80 focus:text-blue-gray-900 active:bg-blue-gray-50 active:bg-opacity-80 active:text-blue-gray-900">
            <div class="grid mr-4 place-items-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"
                class="w-5 h-5">
          ...
          <div role="button"
            ...
            <div
              onClick={() => handleOptionClickLocal('settings')}
            >
              Settings
            </div>
          </div>
